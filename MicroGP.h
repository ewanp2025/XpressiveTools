...
public:
    ...
    struct DiscoveryResult {
        ...
        DiscoveryResult(QString expr, std::unique_ptr<GPNode> t)
            : expression(std::move(expr)), tree(std::move(t)) {}
...
private:
    ...
    std::unique_ptr<GPNode> createClassicFmTree();
    std::unique_ptr<GPNode> createSuperSawTree();
